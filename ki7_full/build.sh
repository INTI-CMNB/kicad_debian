...
docker tag ghcr.io/inti-cmnb/kicad7_debian:latest_full ghcr.io/inti-cmnb/kicad_debian:ki${TG1}_Debian_full
docker tag ghcr.io/inti-cmnb/kicad7_debian:latest_full ghcr.io/inti-cmnb/kicad7_debian:${TG1}_${TG2}_${TG3}
